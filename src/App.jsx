    ...
    return (
        <div className={`min-h-screen transition-all duration-500 overflow-x-hidden ${theme === 'dark' ? 'dark bg-[#0a0a0c] text-white' : 'bg-[#fafafa] text-slate-900 font-medium'}`}>
            ...
            {view !== 'master' && view !== 'onboarding' && view !== 'landing' && view !== 'command' && !settings.isSuspended && (
                <>
                    <header className={`fixed top-0 inset-x-0 z-[700] backdrop-blur-xl border-b transition-all duration-500 safe-top bg-card/80 border-primary/5 shadow-glass md:bg-transparent md:border-none md:shadow-none`}>
                        <div className="max-w-5xl mx-auto px-4 md:px-6 h-16 md:h-20 flex items-center justify-between relative">
                            ...
                            <div className="flex items-center gap-2">
                                <ThemeToggle theme={theme} onClick={toggleTheme} className="md:fixed md:top-8 md:right-8 md:z-[800]" />
                                {view === 'admin' && (
                                    <button
                ...
                <>
                    ...
                    {view === 'user' && (
                        <div className="pb-safe min-h-[calc(100vh-120px)] animate-fade-in">
                            <div className={`relative px-4 transition-all duration-500 text-center ${step === 1 ? 'pt-8 pb-10' : 'pt-4 pb-4'}`}>
                                <button
                                    onClick={handleSecretAdminAccess}
                                    className={`flex items-center justify-center mx-auto active:scale-95 transition-all duration-500 ${step === 1 ? 'w-36 mb-6' : 'w-20 mb-2'}`}
                                >
                                ...
                                <h1 className={`font-black text-primary tracking-tight leading-none transition-all duration-500 ${step === 1 ? 'text-4xl' : 'text-xl'}`}>
                                    {step === 1 ? <>Orlas<br /><span className="text-accent">2026</span></> : <>Orlas <span className="text-accent">2026</span></>}
                                </h1>

                            </div>

                            <main className={`max-w-lg mx-auto px-4 transition-all duration-500 ${step === 1 ? 'space-y-8 mt-4' : 'space-y-4 mt-0'} sm:mt-0`}>
                                {!orderCompleted ? (
                                    <>
                        ...
                        view === 'admin' && (
                            <div className="pt-0 pb-8 min-h-screen animate-fade-in">
                                <div className="max-w-5xl mx-auto px-4">
                                    ...
                                    <div className="flex flex-col md:flex-row items-center md:items-center gap-3 md:gap-6 mb-6 md:mb-8 mt-2">
                                        ...
                                        <div className="flex flex-col text-center md:text-left text-primary md:border-l md:border-primary/10 md:pl-6 leading-none">
                                            <div className="flex items-center justify-center md:justify-start gap-2 mb-1">
                                                ...
                                                <span className="text-[7px] md:text-[10px] font-black text-amber-500 uppercase tracking-widest leading-none">Panel Admin</span>
                                        ...
                                        <div className="max-w-5xl mx-auto">
                                            ...
                                            <div className="md:hidden relative">
                                                <button
                                                    ...
                                                    className="w-full flex items-center justify-between p-3 bg-primary/5 border border-primary/10 rounded-2xl backdrop-blur-md shadow-lg"
                                                >
                                                    <div className="flex items-center gap-3">
                                    ...
                                    <div className="card p-4 md:p-4 bg-gradient-to-br from-indigo-900/10 to-transparent border-indigo-500/20 mb-6 border-2 sticky top-[100px] md:top-[152px] z-[35] backdrop-blur-xl mx-2 md:mx-0 shadow-2xl">
                                                        ...
                                                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                                                            <div className="relative">
                                                                ...
                                                                <select value={shootFilters.course} onChange={e => setShootFilters(p => ({ ...p, course: e.target.value, group: '' }))} className="w-full bg-primary/5 border border-primary/10 text-primary text-xs font-black rounded-xl px-4 py-3.5 cursor-pointer outline-none hover:bg-primary/10 transition-all appearance-none bg-[url('data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20fill%3D%22none%22%20viewBox%3D%220%200%2024%2024%20stroke%3D%22currentColor%22%3E%3Cpath%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%20stroke-width%3D%222%22%20d%3D%22M19%209l-7%207-7-7%22%20%2F%3E%3C%2Fsvg%3E')] bg-[length:16px] bg-[right_1rem_center] bg-no-repeat min-h-[48px]">
                                                                    ...
                                                                    {activeCourses.map(c => <option key={c.name} value={c.name} className="text-slate-900">{c.name}</option>)}
                                                                </select>
                                                            </div>
                                                            <div className="relative">
                                                                ...
                                                                <select value={shootFilters.group} onChange={e => setShootFilters(p => ({ ...p, group: e.target.value }))} className="w-full bg-primary/5 border border-primary/10 text-primary text-xs font-black rounded-xl px-4 py-3.5 cursor-pointer outline-none hover:bg-primary/10 transition-all appearance-none bg-[url('data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20fill%3D%22none%22%20viewBox%3D%220%200%2024%2024%20stroke%3D%22currentColor%22%3E%3Cpath%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%20stroke-width%3D%222%22%20d%3D%22M19%209l-7%207-7-7%22%20%2F%3E%3C%2Fsvg%3E')] bg-[length:16px] bg-[right_1rem_center] bg-no-repeat min-h-[48px]">
                                                                    ...
                                                                    {availGroups.map(g => <option key={g} value={g} className="text-slate-900">Grupo {g}</option>)}
                                                                </select>
                                                            </div>
                                                            <div className="relative">
                                    ...
                                    {adminTab === 'design' && (
                                        <div className={`animate-fade-in max-w-7xl mx-auto ${isFullScreenDesign ? 'fixed inset-0 z-[600] bg-card p-0 flex flex-col overflow-hidden' : 'space-y-6 pb-20'}`}>
                                            ...
                                            <div className={`flex-1 flex flex-col relative ${isFullScreenDesign ? 'h-full overflow-hidden' : ''}`}>
                                                ...
                                                {isFullScreenDesign && (
                                                    <div className={`p-3 md:p-4 px-4 md:px-8 border-b flex items-center justify-between backdrop-blur-md z-50 sticky top-0 md:relative ${theme === 'dark' ? 'border-white/5 bg-black/80' : 'border-black/5 bg-white/90'
                                                        }`}>
                                                        <div className="flex items-center gap-3">
                                                            <button onClick={() => setIsFullScreenDesign(false)} className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all border active:scale-95 ${theme === 'dark' ? 'bg-white/5 border-white/5 text-white/60 hover:text-white' : 'bg-black/5 border-black/5 text-black/60 hover:text-black'
                                                                }`}><ArrowRight size={18} className="rotate-180" /></button>
                                                            <div className="flex flex-col">
                                                                <span className={`text-[7px] font-black uppercase tracking-[0.35em] leading-none mb-0.5 ${theme === 'dark' ? 'text-white/25' : 'text-black/30'}`}>Powered by</span>
                                                                <span className={`text-[10px] font-black uppercase tracking-[0.15em] leading-none ${theme === 'dark' ? 'text-white' : 'text-black'}`}>Pujalte Creative Studio</span>
                                                            </div>
                                                        </div>

                                                        {/* ZOOM & PAN */}
                                                        <div className={`flex items-center rounded-2xl border p-1 gap-0.5 ${theme === 'dark' ? 'bg-white/5 border-white/10' : 'bg-black/5 border-black/10'
                                                            }`}>
                                                            <button onClick={() => setCanvasZoom(z => Math.max(0.1, z - 0.1))} className={`w-9 h-9 md:w-8 md:h-8 flex items-center justify-center rounded-xl active:scale-90 ${theme === 'dark' ? 'text-white/60 hover:text-white' : 'text-black/60 hover:text-black'
                                                                }`}><ZoomOut size={16} /></button>
                                                            <span className={`text-[11px] font-black px-2 min-w-[45px] text-center ${theme === 'dark' ? 'text-white' : 'text-black'}`}>{Math.round(canvasZoom * 100)}%</span>
                                                            <button onClick={() => setCanvasZoom(z => Math.min(3, z + 0.1))} className={`w-9 h-9 md:w-8 md:h-8 flex items-center justify-center rounded-xl active:scale-90 ${theme === 'dark' ? 'text-white/60 hover:text-white' : 'text-black/60 hover:text-black'
                                                                }`}><ZoomIn size={16} /></button>
                                                            <button onClick={() => { setCanvasZoom(1); setPanOffset({ x: 0, y: 0 }); }} className="px-3 py-1.5 text-[9px] font-black uppercase text-violet-500 hover:text-violet-400">RESET</button>
                                                        </div>
                                                    </div>
                                                )}
                                                ...
                                                {isFullScreenDesign && (() => {
                                                    ...
                                                    const TOOLS = [
                                                        { icon: LayoutGrid, label: 'Columnas', key: 'aCols', min: 1, max: 20, unit: 'UD' },
                                                        { icon: ArrowUpDown, label: 'Eje Y Alu', key: 'aStartY', min: mmToPx(50), max: mmToPx(280) },
                                                        { icon: MoveVertical, label: 'Sep. Filas', key: 'aGapY', min: mmToPx(2), max: mmToPx(150) },
                                                        { icon: UserSquare2, label: 'Eje Y Doc', key: 'dY', min: mmToPx(10), max: mmToPx(150) },
                                                            ...
                                                            {activeDesignParam && (
                                                                <div className="px-5 pt-4 pb-2">
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        step={activeDesignParam.step || 0.1}
                                                                        ...
                                                                        onTouchMove={e => {
                                                                            ...
                                                                            const step = activeDesignParam.step || 0.1;
                                                ...
                                                <div className={`card ${isFullScreenDesign ? 'border-none bg-transparent h-full p-0 flex flex-col' : 'p-8 border-violet-500/20 bg-violet-500/5 dark:bg-violet-500/5 relative overflow-hidden'}`}>
                                                    {/* Header Previa */}
                                                    {!isFullScreenDesign && (
                                                        <div className="flex flex-col items-center gap-4 mb-8 relative z-10 text-center sm:flex-row sm:justify-between sm:text-left">
                                                            ...
                                                            <button
                                                                ...
                                                                className="w-full sm:w-auto px-8 py-4 bg-violet-600 hover:bg-violet-500 text-white rounded-2xl font-black text-xs uppercase tracking-[0.2em] flex items-center justify-center gap-3 transition-all shadow-xl shadow-violet-600/20 active:scale-95 group"
                                                            >
                                                    ...
                                                    <div
                                                        ...
                                                        className={`relative select-none overflow-hidden touch-none ${isFullScreenDesign ? `flex-1 ${theme === 'dark' ? 'bg-[#0a0a0a]' : 'bg-[#f0f2f5]'} flex flex-col items-center justify-center p-4 overflow-auto custom-scrollbar` : 'w-full flex items-center justify-center p-8 bg-black/20 rounded-3xl border border-white/5 cursor-grab active:cursor-grabbing min-h-[500px]'}`}
                                                        style={{ cursor: isFullScreenDesign ? 'grab' : 'grab' }}
                                                    >
                                                        {/* Preview del Canvas */}
                                                        <div className={`transition-all duration-500 select-none ${isFullScreenDesign ? 'w-full flex items-center justify-center' : 'w-full flex justify-center'}`}>
                                                            <div className="relative bg-white shadow-[0_0_100px_rgba(0,0,0,0.5)] rounded-sm overflow-hidden"
                                                                style={{
                                                                    ...
                                                                    transform: `translate(${panOffset.x}px, ${panOffset.y}px) scale(${isFullScreenDesign ? (window.innerWidth < 1024 ? canvasZoom * 0.75 : canvasZoom * 1.5) : 1})`,
                                                        ...
                                                        <div className="mt-8 pt-8 border-t border-violet-500/10 flex flex-col items-center gap-4 text-center">
                                                            <div className="flex items-center gap-2 p-1.5 bg-black/20 rounded-2xl border border-white/5">
                                                                ...
                                                                <select
                                                                    ...
                                                                    onChange={e => setDesignFilter(p => ({ ...p, school: e.target.value, course: '', group: '' }))}
