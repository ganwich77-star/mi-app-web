        ...
        <div className={`min-h-screen transition-all duration-500 overflow-x-hidden ${theme === 'dark' ? 'dark bg-[#0a0a0c] text-white' : 'bg-[#fafafa] text-slate-900 font-medium'}`}>
            ...
            {settings.isSuspended ? (
                ...
                <>
                    ...
                    {view === 'landing' && <Landing onAdminAccess={handleSecretAdminAccess} />}
                        ...
                        <div className="pb-safe min-h-[calc(100vh-120px)] animate-fade-in">
                            <div className={`relative px-4 transition-all duration-500 text-center ${step === 1 ? 'pt-8 pb-10' : 'pt-4 pb-4'}`}>
                                <button
                                    ...
                                    className={`flex items-center justify-center mx-auto active:scale-95 transition-all duration-500 relative z-[750] pointer-events-auto ${step === 1 ? 'w-36 mb-6' : 'w-20 mb-2'}`}
                                >
                                                        ...
                                                        >
                                                            ...
                                                            <div className="flex items-center">
                                                                ...
                                                                <button
                                                                    ...
                                                                    id="btn-guardar-orla"
                                                                    className={`flex-shrink-0 flex flex-col items-center gap-1 px-3 py-3 active:scale-90 transition-all border-r ${textMuted} ${dividerColor}`}
                                                                >
                                                                    <Check size={18} />
